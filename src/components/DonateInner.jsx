    ...
    <section className="donate-accounts-section">
      <div className="container py-5">
        <div className="row justify-content-center g-4">
          ...
          {/* Card 1 */}
          <div className="col-12 col-md-6 col-lg-5">
            <div className="card border-2 border-success shadow-lg h-100  animate__animated animate__fadeInUp">
              <img
                src="/assets/images/donation/non-zakat.jpg"
                alt="NBP Donation"
          ...
          <div className="col-12 col-md-6 col-lg-5">
            <div className="card border-2 border-success shadow-lg h-100  animate__animated animate__fadeInUp">
              <img
                src="/assets/images/donation/zakat.jpg"
                alt="JS Bank Donation"
                className="img-fluid rounded"
                style={{ width: "100%", height: "auto" }}
              />
            </div>
