      ...
      <div className='container'>
        <div className='row'>
          <div className='col-12'>
            <div className='image-marquee__slider swiper'>
              <Slider {...settings} className='swiper-wrapper'>
                <div className='swiper-slide'>
                  <div className='image-marquee__slider-single'>
                    <img
                ...
                <div className='swiper-slide'>
                  <div className='image-marquee__slider-single'>
                    <img
                      src='/assets/images/marquee/9.jpg'
                      alt='Gallery Image 1'
                      className='img-fluid'
                    />
                  </div>
                ...
                <div className='swiper-slide'>
                  <div className='image-marquee__slider-single'>
                    <img
                      src='/assets/images/marquee/10.jpg'
                      alt='Gallery Image 2'
                      className='img-fluid'
                    />
                  </div>
                ...
                <div className='swiper-slide'>
                  <div className='image-marquee__slider-single'>
                    <img
                      src='/assets/images/marquee/11.jpeg'
                      alt='Gallery Image 3'
                      className='img-fluid'
                    />
                  </div>
                ...
                <div className='swiper-slide'>
                  <div className='image-marquee__slider-single'>
                    <img
                      src='/assets/images/marquee/12.jpg'
                      alt='Gallery Image 4'
                      className='img-fluid'
                    />
                  </div>
